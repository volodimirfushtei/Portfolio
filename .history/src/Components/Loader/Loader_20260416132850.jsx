...
const images = [
  {
    id: 0,
    src: "/images/wyss.jpg",
    srcMobile: "/images/sity-portrait.webp",   // Додайте мобільні версії
    srcDesktop: "/images/wyss-desktop.jpg", // Додайте десктопні версії
    alt: "Code abstraction",
  },
  {
    id: 1,
    src: "/images/business.jpg",
    srcMobile: "/images/preview-portrait.webp",
    srcDesktop: "/images/business-desktop.jpg",
    alt: "UI Design",
  },
  {
    id: 2,
    src: "/images/happyt.jpg",
    srcMobile: "/images/sity-portrait.webp",
    srcDesktop: "/images/happyt-desktop.jpg",
    alt: "Technology",
  },
  {
    id: 3,
    src: "/images/njeromin1.jpg",
    srcMobile: "/images/njeromin1-mobile.jpg",
    srcDesktop: "/images/njeromin1-desktop.jpg",
    alt: "Creative thinking",
  },
  {
    id: 4,
    src: "/images/office.jpg",    
    srcMobile: "/images/office-mobile.jpg",
    srcDesktop: "/images/office-desktop.jpg",
    alt: "Collaboration",
  },
];
        ...
        >
          ...
          >
            <div className={styles.slidesContainer}>
              {images.slice(0, 5).map((img, index) => (  // Додано slice(0,3)
                <motion.div
                  key={img.id}
                ...
                >
                  <picture>
                    {/* Mobile (портрет) - 600x1000 */}
                    <source
                      media="(max-width: 3800px)"
                      srcSet={img.srcMobile || img.src}
                    />
                    {/* Desktop (пейзаж) */}
                    <source
                      media="(min-width: 601px)"
                      srcSet={img.srcDesktop || img.src}
                    />
                    {/* Fallback */}
                    <img
                      src={img.src}
                      alt={img.alt}
                      className={styles.previewImage}  // Новий клас
                      loading="lazy"
                    />
                  </picture>
