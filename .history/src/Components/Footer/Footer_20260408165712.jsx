...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const letters = getStartedRef.current.querySelectorAll('span')
      const oddLetters = Array.from(letters).filter((_, i) => i % 2 === 0)
      const evenLetters = Array.from(letters).filter((_, i) => i % 2 !== 0)
  ...
  return (
    ...
    >
      ...
      <div className={styles.getStarted} ref={getStartedRef}>
        <span ref={evenRef}>G</span><span ref={oddRef}>E</span><span ref={evenRef}>T</span>{' '}<span ref={oddRef}>S</span> 
        <span ref={evenRef}>T</span><span ref={oddRef}>A</span><span ref={evenRef}>R</span><span ref={oddRef}>T</span>
        <span ref={evenRef}>E</span><span ref={oddRef}>D</span>
      </div>
