...
const quickLinks = [
  { icon: 'icon-home', text: 'Home', url: '#home' },
  { icon: 'icon-project', text: 'Projects', url: '#projects' },
  { icon: 'icon-tech', text: 'Tech', url: '#tech' },
  { icon: 'icon-contact', text: 'Contacts', url: '#contacts' },
]
