...
const bgPositionSpringText = useSpring(bgPosition, {
  ...
  return (
    ...
    >
      ...
      <div className={styles.getStarted} ref={lettersRef} aria-label="Get Started" style={{width: '100%', backgroundPositionY: bgPositionSpringText,position: 'absolute', bottom: '50px', left: '50%', transform: 'translateX(-50%)', zIndex: 3 }}>
