...
const bgPositionSpringText = useSpring(bgPosition, {
  ...
  return (
    ...
    >
      ...
      <div className={styles.getStarted} aria-label="Get Started" style={{width: '100%', backgroundPositionY: bgPositionSpringText,position: 'absolute', bottom: '40px', left: '50%', transform: 'translateX(-50%)', zIndex: 3 }}>
