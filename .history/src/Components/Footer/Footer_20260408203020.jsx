...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className={styles.getStarted} aria-label="Get Started" style={{ backgroundPositionY: bgPositionSpring,position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)', zIndex: 3 }}>
