...
import { SectionBadge } from "../../Components/SectionBadge/SectionBadge.jsx";
import { useRef } from "react";
import { useScroll, useTransform } from "framer-motion";
import StickyZoomSection from "../../Components/StickyZoomSection/StickyZoomSection.jsx";
import SectionBadge from "./../../../.history/src/Components/SectionBadge/SectionBadge_20260311115936";
...
const HomePage = () => {
  ...
  const SECTIONS = [
    { id: "hero", number: "01", label: "Hero", Component: HeroSection },
    { id: "expertise", number: "02", label: "Expertise", Component: Expertise },
    // ...
  ];
  return (
    <motion.div
