  ...
  const projects = [
    {
      ...
      imageUrl:
        "https://readdy.ai/api/search-image?query=e-commerce%2520mobile%2520app%2520interface%2520on%2520smartphone%252C%2520shopping%2520app%2520with%2520product%2520listings%252C%2520modern%2520UI%2520with%2520yellow%2520accent%2520colors%252C%2520clean%2520design%252C%2520high%2520quality%2520screenshot&width=600&height=800&seq=12&orientation=portrait",
        ...
        <div className="container h-[90vh] px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {projects.map((project) => (
              <div
                key={project.id}
                className="project-card bg-[linear-gradient(90deg,rgba(00,00,00,0.6),rgba(94,96,209,0.6))] w-75 rounded-lg overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105 hover:-translate-y-2 cursor-pointer hover:z-10"
              >
