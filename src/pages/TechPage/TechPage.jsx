...
const TechnologyPage = () => {
  ...
  const current = useMemo(
    () => techStack.slice((currentPage - 1) * PER_PAGE, currentPage * PER_PAGE),
    [currentPage],
  )
        ...
        <header ref={headerRef} className={styles.header}>
          ...
          <h1 className={styles.heading}>
            <div className={styles.headingLine}>
              <span>My</span>{' '}
              <span className={styles.headingAccent}>Tech Stack</span>
            </div>
          </h1>
          <p className={styles.subheading}>
            A curated collection of tools and technologies utilized to craft
