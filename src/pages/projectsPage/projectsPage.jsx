    ...
    return (
      <div className={styles.loadingWrap}>
        <div className={styles.loadingInner}>
          <svg width="40" height="40" className={styles.spinner}>
            <use href="/sprite.svg#icon-loader" />
          </svg>
                ...
                >
                  ...
                  <div className={styles.cardBody}>
                    ...
                    >
                      ...
                      <i
                        className={project.urlVercel || project.urlGitHub ? 'ri-arrow-right-up-line' : 'ri-lock-line'} />
                    </a>
                  </div>
                </article>
              </div>
