          ...
          <address className={styles.contactInfo}>
            {contactInfo.map((item, index) => (
              <p key={index}>
                ...
                {item.url ? (
                  <a className={styles.contactLink} href={item.url}>
                    {item.text}
                  </a>
                ) : (
...
const quickLinks = [
  { icon: 'icon-home', name: 'Hero', url: '#hero' },
  { icon: 'icon-projects', name: 'Projects', url: '#projects' },
  { icon: 'icon-tech', name: 'Tech', url: '#tech' },
  { icon: 'icon-contacts', name: 'Contacts', url: '#contacts' },
]

const contactInfo = [
  { icon: 'icon-map-pin', text: 'Ivano-Frankivsk, Ukraine' },
  {
    icon: 'icon-mail',
